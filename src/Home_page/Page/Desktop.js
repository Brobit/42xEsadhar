export default class Desktop
{
	...
	createCreditContent(div)
	{
		...
		this.creditTitle.classList.add("webgl", "credit_text", "credit_title_desktop");
		...
		this.artistRole.classList.add("webgl", "credit_text", "artist_role_desktop");
		...
		this.devRole.classList.add("webgl", "credit_text", "dev_role_desktop");
