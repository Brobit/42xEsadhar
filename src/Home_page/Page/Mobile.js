export default class Mobile
{
	...
	createCloseCross(div)
	{
		...
		// this.tutorialCross.classList.add("webgl", "parent2", "div_pop_up", "closev2_mobile");
	...
	createTutorialContent(div)
	{
		...
		this.leftButton.textContent = "Bouton de gauche : Sert à changer la vue 3 ème personne en vue orbital.";
